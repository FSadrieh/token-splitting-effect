...
# python train.py --config cfgs/emotion/5_models/init_seeds/emotion_5_model_init_0.yml
...
# python train.py --config cfgs/emotion/5_models/train_seeds/emotion_5_model_train_0.yml
